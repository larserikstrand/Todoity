 ...
 * on 2014-04-07 at 08:54:44 UTC 
 * Modify at your own risk.
 */

package no.hig.strand.lars.todoity.taskentityendpoint;
...
public class Taskentityendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.16.0-rc of the taskentityendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   *
   * This request holds the parameters needed by the the taskentityendpoint server.  After setting any
  ...
  public class GetTaskEntity extends TaskentityendpointRequest<no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity> {
    ...
    protected GetTaskEntity(java.lang.String id) {
      super(Taskentityendpoint.this, "GET", REST_PATH, null, no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity.class);
   ...
   * operation.
   *
   * @param content the {@link no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity}
   * @return the request
   */
  public InsertTaskEntity insertTaskEntity(no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity content) throws java.io.IOException {
    InsertTaskEntity result = new InsertTaskEntity(content);
    initialize(result);
    return result;
  }

  public class InsertTaskEntity extends TaskentityendpointRequest<no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity> {
     ...
     * @since 1.13
     */
    protected InsertTaskEntity(no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity content) {
      super(Taskentityendpoint.this, "POST", REST_PATH, content, no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity.class);
    }
  ...
  /**
   * Create a request for the method "listTaskEntity".
   *
   * This request holds the parameters needed by the the taskentityendpoint server.  After setting any
   * optional parameters, call the {@link ListTaskEntity#execute()} method to invoke the remote
   * operation.
   *
   * @return the request
   */
  public ListTaskEntity listTaskEntity() throws java.io.IOException {
    ListTaskEntity result = new ListTaskEntity();
    initialize(result);
    return result;
  }

  public class ListTaskEntity extends TaskentityendpointRequest<no.hig.strand.lars.todoity.taskentityendpoint.model.CollectionResponseTaskEntity> {
     ...
     *
     * This request holds the parameters needed by the the taskentityendpoint server.  After setting
     * any optional parameters, call the {@link ListTaskEntity#execute()} method to invoke the remote
     * operation. <p> {@link ListTaskEntity#initialize(com.google.api.client.googleapis.services.Abstr
     * actGoogleClientRequest)} must be called to initialize this instance immediately after invoking
     * the constructor. </p>
     *
     * @since 1.13
     */
    protected ListTaskEntity() {
      super(Taskentityendpoint.this, "GET", REST_PATH, null, no.hig.strand.lars.todoity.taskentityendpoint.model.CollectionResponseTaskEntity.class);
    }
    ...
    @Override
    public ListTaskEntity setAlt(java.lang.String alt) {
      return (ListTaskEntity) super.setAlt(alt);
    }

    @Override
    public ListTaskEntity setFields(java.lang.String fields) {
      return (ListTaskEntity) super.setFields(fields);
    }

    @Override
    public ListTaskEntity setKey(java.lang.String key) {
      return (ListTaskEntity) super.setKey(key);
    }

    @Override
    public ListTaskEntity setOauthToken(java.lang.String oauthToken) {
      return (ListTaskEntity) super.setOauthToken(oauthToken);
    }

    @Override
    public ListTaskEntity setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ListTaskEntity) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ListTaskEntity setQuotaUser(java.lang.String quotaUser) {
      return (ListTaskEntity) super.setQuotaUser(quotaUser);
    }

    @Override
    public ListTaskEntity setUserIp(java.lang.String userIp) {
      return (ListTaskEntity) super.setUserIp(userIp);
    }
    ...
    public ListTaskEntity setCursor(java.lang.String cursor) {
      this.cursor = cursor;
      return this;
    }
    ...
    public ListTaskEntity setLimit(java.lang.Integer limit) {
      this.limit = limit;
      return this;
    }

    @Override
    public ListTaskEntity set(String parameterName, Object value) {
      return (ListTaskEntity) super.set(parameterName, value);
    }
  }
   ...
   * @return the request
   */
  public UpdateTaskEntity updateTaskEntity(no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity content) throws java.io.IOException {
    UpdateTaskEntity result = new UpdateTaskEntity(content);
    initialize(result);
    return result;
  }

  public class UpdateTaskEntity extends TaskentityendpointRequest<no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity> {
     ...
     * @since 1.13
     */
    protected UpdateTaskEntity(no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity content) {
      super(Taskentityendpoint.this, "PUT", REST_PATH, content, no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity.class);
    }
