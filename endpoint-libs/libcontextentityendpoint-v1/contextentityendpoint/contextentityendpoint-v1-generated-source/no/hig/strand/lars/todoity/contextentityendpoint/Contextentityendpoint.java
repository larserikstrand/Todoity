...
package no.hig.strand.lars.todoity.contextentityendpoint;
...
public class Contextentityendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.16.0-rc of the contextentityendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   *
   * This request holds the parameters needed by the the contextentityendpoint server.  After setting
   * any optional parameters, call the {@link GetContextEntity#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @return the request
  ...
  public class GetContextEntity extends ContextentityendpointRequest<no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity> {
    ...
    protected GetContextEntity(java.lang.Long id) {
      super(Contextentityendpoint.this, "GET", REST_PATH, null, no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity.class);
   ...
   *
   * This request holds the parameters needed by the the contextentityendpoint server.  After setting
   * any optional parameters, call the {@link InsertContextEntity#execute()} method to invoke the
   * remote operation.
   *
   * @param content the {@link no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity}
   * @return the request
   */
  public InsertContextEntity insertContextEntity(no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity content) throws java.io.IOException {
    InsertContextEntity result = new InsertContextEntity(content);
    initialize(result);
    return result;
  }

  public class InsertContextEntity extends ContextentityendpointRequest<no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity> {
     ...
     * @since 1.13
     */
    protected InsertContextEntity(no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity content) {
      super(Contextentityendpoint.this, "POST", REST_PATH, content, no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity.class);
    }
  ...
  /**
   * Create a request for the method "listContextEntity".
   *
   * This request holds the parameters needed by the the contextentityendpoint server.  After setting
   * any optional parameters, call the {@link ListContextEntity#execute()} method to invoke the remote
   * operation.
   *
   * @return the request
   */
  public ListContextEntity listContextEntity() throws java.io.IOException {
    ListContextEntity result = new ListContextEntity();
    initialize(result);
    return result;
  }

  public class ListContextEntity extends ContextentityendpointRequest<no.hig.strand.lars.todoity.contextentityendpoint.model.CollectionResponseContextEntity> {
     ...
     *
     * This request holds the parameters needed by the the contextentityendpoint server.  After
     * setting any optional parameters, call the {@link ListContextEntity#execute()} method to invoke
     * the remote operation. <p> {@link ListContextEntity#initialize(com.google.api.client.googleapis.
     * services.AbstractGoogleClientRequest)} must be called to initialize this instance immediately
     * after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected ListContextEntity() {
      super(Contextentityendpoint.this, "GET", REST_PATH, null, no.hig.strand.lars.todoity.contextentityendpoint.model.CollectionResponseContextEntity.class);
    }
    ...
    @Override
    public ListContextEntity setAlt(java.lang.String alt) {
      return (ListContextEntity) super.setAlt(alt);
    }

    @Override
    public ListContextEntity setFields(java.lang.String fields) {
      return (ListContextEntity) super.setFields(fields);
    }

    @Override
    public ListContextEntity setKey(java.lang.String key) {
      return (ListContextEntity) super.setKey(key);
    }

    @Override
    public ListContextEntity setOauthToken(java.lang.String oauthToken) {
      return (ListContextEntity) super.setOauthToken(oauthToken);
    }

    @Override
    public ListContextEntity setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ListContextEntity) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ListContextEntity setQuotaUser(java.lang.String quotaUser) {
      return (ListContextEntity) super.setQuotaUser(quotaUser);
    }

    @Override
    public ListContextEntity setUserIp(java.lang.String userIp) {
      return (ListContextEntity) super.setUserIp(userIp);
    }
    ...
    public ListContextEntity setCursor(java.lang.String cursor) {
      this.cursor = cursor;
      return this;
    }
    ...
    public ListContextEntity setLimit(java.lang.Integer limit) {
      this.limit = limit;
      return this;
    }

    @Override
    public ListContextEntity set(String parameterName, Object value) {
      return (ListContextEntity) super.set(parameterName, value);
    }
  }
   ...
   *
   * This request holds the parameters needed by the the contextentityendpoint server.  After setting
   * any optional parameters, call the {@link RemoveContextEntity#execute()} method to invoke the
   * remote operation.
   *
   * @param id
   * @return the request
   ...
   *
   * This request holds the parameters needed by the the contextentityendpoint server.  After setting
   * any optional parameters, call the {@link UpdateContextEntity#execute()} method to invoke the
   * remote operation.
   *
   * @param content the {@link no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity}
   * @return the request
   */
  public UpdateContextEntity updateContextEntity(no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity content) throws java.io.IOException {
    UpdateContextEntity result = new UpdateContextEntity(content);
    initialize(result);
    return result;
  }

  public class UpdateContextEntity extends ContextentityendpointRequest<no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity> {
     ...
     * @since 1.13
     */
    protected UpdateContextEntity(no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity content) {
      super(Contextentityendpoint.this, "PUT", REST_PATH, content, no.hig.strand.lars.todoity.contextentityendpoint.model.ContextEntity.class);
    }
